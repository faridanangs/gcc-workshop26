...
export function Globe3DDemoThird() {
  return (
    <div
      className="relative mx-auto h-[400px] w-full max-w-7xl overflow-hidden rounded-xl bg-white shadow-sm ring-1 shadow-black/10 ring-black/10 dark:bg-neutral-950">
      <div className="relative z-10 p-4 md:p-12">
        <h2
          className="mb-4 max-w-2xl text-2xl font-extrabold tracking-tight text-balance text-neutral-900 md:text-5xl lg:text-6xl dark:text-white">
          Play all over the world with a click.
        </h2>
        <p
          className="mt-2 max-w-lg text-balance text-neutral-600 md:mt-8 md:text-lg dark:text-neutral-400">
      ...
      <div
        className="absolute -right-72 -bottom-96 z-10 size-160 md:-bottom-80 md:size-180">
        <Globe3D
